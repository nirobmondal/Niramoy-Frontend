...
- `GET /api/medicines/<medicine-id>` returns full details with seller and category.

---

## Step 6: Customer Shops (Cart → Checkout)
...
## Step 8: Customer Reviews Medicine
...
## Step 9: Order Cancellation (Stock Restoration)
