...
5. [Medicines (Public)](#5-medicines)
6. [Cart (Customer)](#6-cart)
7. [Orders (Customer)](#7-orders)
8. [Seller](#8-seller)
9. [Reviews](#9-reviews)
10. [Admin](#10-admin)
...
### 5.1 Get All Medicines (Public)

```
GET {{baseUrl}}/api/medicines?page=1&limit=10&search=amox&category=uuid&sortBy=price&sortOrder=asc&minPrice=10&maxPrice=500
```
